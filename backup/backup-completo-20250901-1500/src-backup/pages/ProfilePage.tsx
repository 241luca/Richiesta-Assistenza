...
// NUOVA FUNZIONALITÀ: Import componenti viaggi per professionisti
...
export function ProfilePage() {
  ...
  const [activeTab, setActiveTab] = useState<'address' | 'costs'>('address');
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {/* NUOVA FUNZIONALITÀ: Viaggi e Distanze - Solo per professionisti */}
      {user?.role === 'PROFESSIONAL' && (
        <>
          {/* Link a Competenze e Sottocategorie */}
          <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4 mt-6 mb-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="font-semibold text-blue-900">Gestisci Competenze e Sottocategorie</h4>
                  <p className="text-sm text-blue-700">Configura le tue specializzazioni e aree di servizio</p>
                </div>
              </div>
              <a 
          ...
          {/* Sezione Viaggi e Distanze con Tab */}
          <div className="bg-white shadow-md rounded-lg">
            <div className="px-6 py-4 border-b border-gray-200">
              ...
              <p className="mt-1 text-sm text-gray-600">
                Configura il tuo indirizzo di lavoro e le tariffe per i costi di trasferta
              </p>
