                ...
                <input
                  ...
                  onChange={async (e) => {
                    ...
                    if (checked && selectedRequestId) {
                      ...
                      try {
                        const response = await apiClient.get(`/travel/request/${selectedRequestId}/travel-info`);
                        if (response.data.success && response.data.data) {
                          const travelData = response.data.data;
                          // Arrotonda la distanza al km intero
                          const roundedDistance = Math.round(travelData.distance);
                          setTravelDistance(roundedDistance);
                          ...
                          const travelItem = {
                            description: `Costi di trasferimento (${roundedDistance} km)`,
                            quantity: 1,
