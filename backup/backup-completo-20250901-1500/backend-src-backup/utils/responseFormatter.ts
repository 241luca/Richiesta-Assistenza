...
export function formatAssistanceRequest(request: any): any {
  ...
  return {
    ...
    quotes: request.Quote || request.quotes ? (request.Quote || request.quotes).map(formatQuote) : [],
    attachments: request.RequestAttachment || request.attachments ? (request.RequestAttachment || request.attachments).map(formatAttachment) : [],
...
export function formatSubcategory(subcategory: any): any {
  ...
  return {
    ...
    _count: subcategory._count ? {
      professionals: subcategory._count.UserProfessionalSubcategory || 
                    subcategory._count.ProfessionalUserSubcategory || 
                    subcategory._count.professionalUsers || 0,
      assistanceRequests: subcategory._count.AssistanceRequest || 
...
export function formatProfessionalSubcategory(profSubcat: any): any {
  ...
  return {
    ...
    // Gestisci relazioni
    user: profSubcat.User || profSubcat.user ? formatUser(profSubcat.User || profSubcat.user) : null,
...
export function formatMessage(message: any): any {
  ...
  return {
    ...
    sender: message.User_Message_senderIdToUser || message.sender ? 
      formatUser(message.User_Message_senderIdToUser || message.sender) : null,
    recipient: message.User_Message_recipientIdToUser || message.recipient ? 
      formatUser(message.User_Message_recipientIdToUser || message.recipient) : null
  };
}
...
export function formatNotification(notification: any): any {
  ...
  return {
    ...
    // Gestisci relazioni
    recipient: notification.User_Notification_recipientIdToUser || notification.recipient ? 
      formatUser(notification.User_Notification_recipientIdToUser || notification.recipient) : null,
    sender: notification.User_Notification_senderIdToUser || notification.sender ? 
      formatUser(notification.User_Notification_senderIdToUser || notification.sender) : null
  };
}
