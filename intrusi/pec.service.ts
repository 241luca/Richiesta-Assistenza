...
// ✅ CORRETTO: Crea istanza Prisma locale
...
export async function confirmAndSendComplaint(
  ...
  try {
    ...
    const details = draftLog.details as unknown;
    ...
    const draftDetails = details as ComplaintDraftDetails;
