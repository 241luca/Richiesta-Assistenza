...
async function main() {
  console.log('🌱 Seeding database COMPLETO con SOTTOCATEGORIE REALI e AI SETTINGS...\n')
  ...
  // 3. SOTTOCATEGORIE REALI E DETTAGLIATE
  console.log('\n📂 Creazione sottocategorie REALI (minimo 5 per categoria)...')
  ...
  // 4. AI SETTINGS PER OGNI SOTTOCATEGORIA
  ...
  for (const subcat of createdSubcategories) {
    ...
    // Crea prompt specifici per ogni sottocategoria
...
- Tempistiche standard di intervento`
  ...
  // 5. RICHIESTE DI ASSISTENZA CON INDIRIZZI REALI
...
- Assistenza post-intervento`,
  ...
  const apiKeys = [
    ...
    },
    {
      ...
      name: 'OpenAI API Key',
      isActive: false // Disattivata finché non inserisci la chiave vera
    },
    {
      service: 'stripe',
...
✅ AI Settings: ${totals.aiSettings} (con PROMPT SPECIFICI!)
